...
.DESCRIPTION
This script uses ALU netaccess protocol for receiving real-time CDR, VoIP and MAO tickets on Ethernet. All received tickets without
...
for ($l = 0; $l -lt $CDRFieldsLength.Count ; $l++)
{ New-Variable -Name "CDRColumn$l" -Value $CDRFieldsLength[$l]
}
...
#  "$([char]0x2502){0,$CDRColumn1}$([char]0x2502){1,$CDRColumn2}$([char]0x2502){2,$CDRColumn3}$([char]0x2502){3,$CDRColumn4}$([char]0x2502){4,$CDRColumn5}$([char]0x2502){5,$CDRColumn6}$([char]0x2502){6,$CDRColumn7}$([char]0x2502){7,$CDRColumn8}$([char]0x2502){8,$CDRColumn9}$([char]0x2502)"  -f $EAShortCDR[0], $EAShortCDR[1], $EAShortCDR[2] , $EAShortCDR[3], $EAShortCDR[4], $EAShortCDR[5], $EAShortCDR[6], $EAShortCDR[7], $EAShortCDR[8]
  "$([char]0x2502){0,$CDRColumn0}$([char]0x2502){1,$CDRColumn1}$([char]0x2502){2,$CDRColumn2}$([char]0x2502){3,$CDRColumn3}$([char]0x2502){4,$CDRColumn4}$([char]0x2502){5,$CDRColumn5}$([char]0x2502){6,$CDRColumn6}$([char]0x2502){7,$CDRColumn7}$([char]0x2502){8,$CDRColumn8}$([char]0x2502)"  -f $EAShortCDR[0], $EAShortCDR[1], $EAShortCDR[2] , $EAShortCDR[3], $EAShortCDR[4], $EAShortCDR[5], $EAShortCDR[6], $EAShortCDR[7], $EAShortCDR[8]
